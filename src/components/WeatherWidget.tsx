...
export default function WeatherWidget({ lat, lng }: { lat: number; lng: number }) {
  ...
  return (
    <div className="flex items-center gap-3 text-[11px] text-ink-300">
      ...
      <InfoTip text="Temperatura real del AIRE, medida/modelada a 2 metros de altura sobre el suelo (altura estándar meteorológica). No es sensación térmica, y no es la temperatura del agua de tus piscinas.">
